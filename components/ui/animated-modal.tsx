      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-50 flex max-h-[90%] min-h-[50%] flex-1 flex-col overflow-hidden border border-transparent bg-white md:max-w-[60%] md:rounded-2xl dark:border-neutral-800 dark:bg-neutral-950",
              className
            )}
            initial={{
              opacity: 0,
